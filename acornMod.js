(function (global, factory) {
  ...
  pp$8.parseFunctionParams = function(node) {
    this.expect(types$1.parenL);
    node.params = this.parseBindingList(types$1.parenR, false, this.options.ecmaVersion >= 8, false, true); // CHANGED last two arguments
  ...
  pp$7.parseBindingAtom = function(allowTypes) {//CHANGED
    if (this.options.ecmaVersion >= 6) {
      switch (this.type) {
  ...
  pp$7.parseBindingList = function(close, allowEmpty, allowTrailingComma, allowModifiers, allowTypes) { // CHANGED final argument
    var elts = [], first = true;
    while (!this.eat(close)) {
      ...
      if (allowEmpty && this.type === types$1.comma) {
        ...
        elts.push(this.parseAssignableListItem(allowModifiers, allowTypes)); //CHANGED
      }
    }
    return elts
  };
  ...
  pp$5.parseIdent = function(liberal, allowTypes) { //CHANGED
